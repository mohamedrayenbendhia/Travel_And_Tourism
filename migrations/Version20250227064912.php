 ...
 */
final class Version20250227064912 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reclamation (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, host_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, photo VARCHAR(255) DEFAULT NULL, document VARCHAR(255) DEFAULT NULL, categorie VARCHAR(255) NOT NULL, statut VARCHAR(255) NOT NULL, date_soumission DATETIME NOT NULL, INDEX IDX_CE606404A76ED395 (user_id), INDEX IDX_CE6064041FB8D185 (host_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
