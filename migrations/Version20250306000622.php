 ...
 */
final class Version20250306000622 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transport CHANGE disponibilte disponibilte TINYINT(1) DEFAULT 0 NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transport CHANGE disponibilte disponibilte TINYINT(1) NOT NULL');
    }
}
