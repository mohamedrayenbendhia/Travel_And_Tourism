 ...
 */
final class Version20250305224104 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE restaurant CHANGE image1 image1 VARCHAR(255) DEFAULT NULL, CHANGE image2 image2 VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE transport ADD user_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE restaurant CHANGE image1 image1 VARCHAR(255) NOT NULL, CHANGE image2 image2 VARCHAR(255) NOT NULL');
    }
}
