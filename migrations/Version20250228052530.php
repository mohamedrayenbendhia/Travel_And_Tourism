 ...
 */
final class Version20250228052530 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE evaluation_reclamation (id INT AUTO_INCREMENT NOT NULL, reclamation_id INT NOT NULL, voyageur_id INT NOT NULL, note INT NOT NULL, commentaire LONGTEXT NOT NULL, INDEX IDX_9D39F0732D6BA2D9 (reclamation_id), INDEX IDX_9D39F07362915402 (voyageur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reclamation (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, host_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, photo VARCHAR(255) DEFAULT NULL, document VARCHAR(255) DEFAULT NULL, categorie VARCHAR(100) NOT NULL, statut VARCHAR(20) NOT NULL, date_soumission DATETIME NOT NULL, INDEX IDX_CE606404A76ED395 (user_id), INDEX IDX_CE6064041FB8D185 (host_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE evaluation_reclamation ADD CONSTRAINT FK_9D39F07362915402 FOREIGN KEY (voyageur_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE notification ADD CONSTRAINT FK_BF5476CAA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE reclamation ADD CONSTRAINT FK_CE606404A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE reclamation ADD CONSTRAINT FK_CE6064041FB8D185 FOREIGN KEY (host_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evaluation_reclamation DROP FOREIGN KEY FK_9D39F07362915402');
        $this->addSql('ALTER TABLE notification DROP FOREIGN KEY FK_BF5476CAA76ED395');
        $this->addSql('ALTER TABLE reclamation DROP FOREIGN KEY FK_CE606404A76ED395');
        $this->addSql('ALTER TABLE reclamation DROP FOREIGN KEY FK_CE6064041FB8D185');
